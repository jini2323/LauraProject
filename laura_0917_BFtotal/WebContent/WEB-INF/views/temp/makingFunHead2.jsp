...
<div class = "AppNavbar_container">
			<div class="AppNavbar_laura_logo">
	            <a href="main" class="original-logo" style="font-size: 2.0rem;">LAURA</a>
	        </div>
	        <div class = "AppNavbar_maker">
	        	<div class = "AppNavbar_icon">
	        		<img src = "${rPath }/img/making_funding/icon.svg">
	        	</div>
	        	<div class = "AppNavbar_username">
	        	...
	        	<div class="AppNavbar_buttonGroup">
	        		<div class = "PreviewButton_container">
	        			<a href = "main">
	        				<span class="material-symbols-outlined">logout</span><span>나가기</span>
	        			</a>
	        		</div>
	        	</div>
			</div>