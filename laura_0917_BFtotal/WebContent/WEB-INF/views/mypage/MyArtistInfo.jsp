			...
			<div class = "profile-box">
				...
				<div class = "profileSide_bar">
					<ul class = "profileSide_bar_list">
						...
						<li>
							<a href= "pwdedit?email=${sessionScope.sessionID}">
								<span>비밀번호 설정</span>
							</a>
						</li>
						<li>
							<a href= "delete?email=${sessionScope.sessionID}">
								<span>회원 탈퇴</span>
							</a>
						</li>
						<c:choose>
							<c:when test="${vo.arstatus == '인증' }">
								<li>
									<a href= "artistDetail?email=${sessionScope.sessionID}">
										<span>인증 정보 확인 · 수정</span>
									</a>
								</li>
							</c:when>
						</c:choose>
				...
				<div class = "contents-box" >
					<div class = "contents">
						<h4>예술인 인증 정보</h4>
										...
										<div class= "content_list_item">
											<a href = "#">
												<dl class = "profileImg">
													<dt>
														<div class ="profile-img">
															<img src="${rPath}/img/member/${vo.arprofilepic}"><!-- 0903_박형지: 이미지 연결함(사이즈 조정 필요) -->
														</div>
														
													</dt>
													<dd>
														<strong>${sessionScope.sessionName}</strong><b>님</b>&nbsp;<span>펀딩 정보에 올라갈 사진</span>
													</dd>
												</dl>
											</a>
											  ...
											  <dl id="emailInput">
											    ...
											    <dd>
											      <div id="emailDisplayWrapper">
											        <span id="emailDisplay">${vo.addr}</span>
											      </div>
											      <div id="emailEditWrapper" style="display: none;">
											        <input type="email" id="emailInputField" name="email" value="${vo.addr}">
											...
											<a href="#" style="display: flex; align-items: center;">
											  <dl id="emailInput">
											    ...
											    <dd>
											      <div id="emailDisplayWrapper">
											        <span id="emailDisplay">${vo.arprofile}</span>
											      </div>
											      <div id="emailEditWrapper" style="display: none;">
											        <input type="email" id="emailInputField" name="email" value="${vo.arprofile}">
											        <button type="button" id="saveBtn" style = "display: inline;border: 1px solid #fff;background-color: rgb(165, 229, 230);margin-left: 10px;border-radius: 4px;width: 40px;height: 25px;"><span>저장</span></button>
											      </div>
											    </dd>
											  </dl>
							...
							<a href="mypage?email="><button type="submit" class="button2"><span>취소</span></button></a>
						</div>
								</form>
