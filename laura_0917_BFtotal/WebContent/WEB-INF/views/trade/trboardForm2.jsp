...
<article>
	...
	<div class="single-blog-wrapper section-padding-0-100">
		...
		<div class="container">
			<%-- boardForm 들어 갈 자리. --%>
			<form action="trinsert" method="post" enctype="multipart/form-data"
				id="upform">
						...
						<div class="col-12 col-md-7">
							<div class="group">
								<input type="text" class="form-control" name="trtitle"
									id="trtitle" maxlength="50" required> <span
									class="highlight"></span> <span class="bar"></span> <label>제목</label>
							</div>
						</div>
						<div class="col-12 col-md-6">
							<div class="group">
								<input type="text" class="form-control" name="trloc" id="trloc"
						...
						<div class="col-12 col-md-6">
							<div class="group">
								<input type="text" class="form-control" name="trprice"
									id="trprice" required> <span class="highlight"></span>
								<span class="bar"></span> <label>비용</label>
							</div>
						</div>
						<div class="col-12">
							<div class="group">
								<textarea class="form-control" name="trcontent" id="trcontent"></textarea>
								<span class="highlight"></span> <span class="bar"></span> <label>내용</label>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<div class="group">
								<input type="hidden" name="trimgn" id="trimgn"> <label>이미지</label>
							</div>
							<div class="group">
								<div class="col-sm-10">
								...
								<span class="highlight"></span> <span class="bar"></span> <img
									src="${rPath}/img/fboard_img/noimage.jpg" id="imgx"
